...
public:
	...
	void on_set(void* member_ptr)
	{
		...
		if (member_ptr == &use_vertex_array) {
			fractal.use_vertex_array(&vertex_array, vertices.size(), GL_TRIANGLE_STRIP);
		}
	...
	void create_gui(void)
	{
		...
		add_member_control(this, "use vertex array for rendering", use_vertex_array);
